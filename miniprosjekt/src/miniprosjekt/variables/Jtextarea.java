...
/**
 * Jtextarea is a child class of BaseMedia
 * 
 * @author Kristoffer
 * @author Kevin
 * 
	...
	public String getAddToTable() {
		...
		if (WordWrapping) {
			wrap = String.format("%s.setLineWrap (true);"
					+ "%n%s.setWrapStyleWord (true);", super.getVariabelname(),
					super.getVariabelname());
		}
